    ...
    <div class="wrapper">
		...
		<div class="row">
			<div class="col-sm-5 col-sm-offset-4 col-md-offset-4 col-lg-offset-4 col-md-5 col-lg-5" style="background:#fff; padding:40px;">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('password.email')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <label for="email" class="control-label">E-Mail Address</label>
                                <input style="background:transparent; color:#555;" id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required>
				...
				<p class="text-center copyright-text">Copyright © 2018 <?php echo e($settings->site_name); ?> All Rights Reserved</p>
				<!-- Copyright Text Ends -->
			</div>
			</div>
		</div>
